 ...
 *       &lt;sequence>
 *         &lt;element name="flightDetails" type="{http://ifaces.training.com/}jetAirways" maxOccurs="unbounded" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class CheckAvailablityResponse {
    ...
    protected List<JetAirways> flightDetails;
     ...
     * 
     */
    public List<JetAirways> getFlightDetails() {
        if (flightDetails == null) {
            flightDetails = new ArrayList<JetAirways>();
        }
