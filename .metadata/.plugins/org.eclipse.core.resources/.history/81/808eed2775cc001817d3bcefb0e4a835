 ...
 *       &lt;sequence>
 *         &lt;element name="donorDetails" type="{http://ifaces.trining.com/}bloodDonor" minOccurs="0"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class GetRequestResponse {
    ...
    protected BloodDonor donorDetails;
     ...
     *     
     */
    public BloodDonor getDonorDetails() {
        return donorDetails;
    }
     ...
     *     
     */
    public void setDonorDetails(BloodDonor value) {
